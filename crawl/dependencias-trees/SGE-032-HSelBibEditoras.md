# SGE-032 - IntelliBR Sistema de Gestão Escolar - Usuário: IntelliBR Sistemas Ano: 2026 UE: 8105 - FLORIANOPOLIS

- Prioridade: P2
- Modulo: Acervo Bibliotecário
- Menu: Catalogação de Acervo > Editora
- URL: https://www.sgebr.com.br/sge8105/sgeteste/hSelBibEditoras.aspx
- WebPanel KB: `HSelBibEditoras`
- Tier conversao: **M**
...
```text
WebPanel:HSelBibEditoras [raiz]
├── Procedure:PConsultaPermissao [calls_procedure_udp_inferred|xml]
├── Transaction:TBbEdi [calls_transaction_inferred|xml]
