# SGE-030 - IntelliBR Sistema de Gestão Escolar - Usuário: IntelliBR Sistemas Ano: 2026 UE: 8105 - FLORIANOPOLIS

- Prioridade: P2
- Modulo: Acervo Bibliotecário
- Menu: Catalogação de Acervo > Tradutor
- URL: https://www.sgebr.com.br/sge8105/sgeteste/hSelBibTradutores.aspx
- WebPanel KB: `HSelBibTradutores`
- Tier conversao: **M**
...
```text
WebPanel:HSelBibTradutores [raiz]
├── Procedure:PConsultaPermissao [calls_procedure_udp_inferred|xml]
├── Transaction:TBbTrd [calls_transaction_inferred|xml]
