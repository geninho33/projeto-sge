# SGE-097 - Dados Cadastrais do Servidor

- Prioridade: P2
- Modulo: Recursos Humanos
- Menu: Trabalhar com Cadastros > Pessoal
- URL: https://www.sgebr.com.br/sge8105/sgeteste/hSelServidorCadastral.aspx
- WebPanel KB: `HSelServidorCadastral`
- Tier conversao: **XL**
...
```text
WebPanel:HSelServidorCadastral [raiz]
...
├── Procedure:PLoginEventos [calls_procedure|index]
├── Procedure:PLoginEventos [calls_procedure_inferred|xml]
├── WebPanel:HAlteraCPFServidor [calls_webpanel_inferred|xml]
│   └── Procedure:PAlteraCPFServidor [calls_procedure|index]
│       ├── Procedure:PGravaAdmLog [calls_procedure|index]
│       ├── Procedure:PIncluiCadastroPessoal [calls_procedure|index]
│       ├── Procedure:PIncluiCadastroServHabilitacao [calls_procedure|index]
│       ├── Procedure:PIncluiProfessorProUca [calls_procedure|index]
│       └── Procedure:PIncluiServidorDocumento [calls_procedure|index]
...
├── WebPanel:HMostraLogsProf [calls_webpanel_inferred|xml]
├── WebPanel:HPrincipal [calls_webpanel_inferred|xml]
├── WebPanel:HSelServidorDocumentos [calls_webpanel_inferred|xml]
├── WebPanel:HSelServidorFunc02 [calls_webpanel_inferred|xml]
│   └── Procedure:PLGPD_String [calls_procedure|index]
├── WebPanel:HSelServidorHab [calls_webpanel_inferred|xml]
├── WebPanel:HSelServidorHabilitacaoCine [calls_webpanel_inferred|xml]
│   └── Procedure:PCgcCpf [calls_procedure|index]
├── WebPanel:HServidorFuncionais [calls_webpanel_inferred|xml]
│   └── Procedure:PCgcCpf [calls_procedure|index]
└── WebPanel:HServidorFuncionaisNovo [calls_webpanel_inferred|xml]
    └── Procedure:PCgcCpf [calls_procedure|index]
```
